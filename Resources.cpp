...
bool Sexy::ExtractResourcesByName(ResourceManager* theResourceManager, const char* theName)
{
	...
	else if (!strcmp(theName, "DelayLoad_Background3Wide"))		return ExtractDelayLoad_Background3WideResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_Background3Unsodded"))	return ExtractDelayLoad_Background3UnsoddedResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_Background3Grass"))	return ExtractDelayLoad_Background3GrassResources(theResourceManager);
	...
	else if (!strcmp(theName, "DelayLoad_Background6AirRaid"))	return ExtractDelayLoad_Background6AirRaidResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundGraveyard"))	return ExtractDelayLoad_BackgroundGraveyardResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundHighground"))return ExtractDelayLoad_BackgroundHighgroundResources(theResourceManager);
...
Image* Sexy::IMAGE_BACKGROUND3WIDE;

bool Sexy::ExtractDelayLoad_Background3WideResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND3WIDE = aMgr.GetImageThrow("IMAGE_BACKGROUND3WIDE");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_BACKGROUND3UNSODDED;

bool Sexy::ExtractDelayLoad_Background3UnsoddedResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND3UNSODDED = aMgr.GetImageThrow("IMAGE_BACKGROUND3UNSODDED");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_BACKGROUND3GRASS;

bool Sexy::ExtractDelayLoad_Background3GrassResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND3GRASS = aMgr.GetImageThrow("IMAGE_BACKGROUND3GRASS");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_BACKGROUNDHIGHGROUND;

bool Sexy::ExtractDelayLoad_BackgroundHighgroundResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDHIGHGROUND = aMgr.GetImageThrow("IMAGE_BACKGROUNDHIGHGROUND");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_BACKGROUND6AIRRAIDBG;
Image* Sexy::IMAGE_BACKGROUND6AIRRAIDCLOUDS;
Image* Sexy::IMAGE_BACKGROUND6AIRRAIDSTARS;

bool Sexy::ExtractDelayLoad_Background6AirRaidResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND6AIRRAIDBG = aMgr.GetImageThrow("IMAGE_BACKGROUND6AIRRAIDBG");
		IMAGE_BACKGROUND6AIRRAIDCLOUDS = aMgr.GetImageThrow("IMAGE_BACKGROUND6AIRRAIDCLOUDS");
		IMAGE_BACKGROUND6AIRRAIDSTARS = aMgr.GetImageThrow("IMAGE_BACKGROUND6AIRRAIDSTARS");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_BACKGROUNDGRAVEYARD;

bool Sexy::ExtractDelayLoad_BackgroundGraveyardResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDGRAVEYARD = aMgr.GetImageThrow("IMAGE_BACKGROUNDGRAVEYARD");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
Image* Sexy::IMAGE_CHALLENGE_THUMBNAILS2;
...
bool Sexy::ExtractDelayLoad_ChallengeScreenResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		IMAGE_CHALLENGE_THUMBNAILS2 = aMgr.GetImageThrow("IMAGE_CHALLENGE_THUMBNAILS2");
...
Image* Sexy::IMAGE_DUMMYMETER;
Image* Sexy::IMAGE_TARGETMETER;
Image* Sexy::IMAGE_TARGET_X;
...
Image* Sexy::IMAGE_SEASHROOM_PUFF1;
Image* Sexy::IMAGE_SPORESHROOM_SPORE;
Image* Sexy::IMAGE_ICY_FUMESHROOM_CLOUD;
Image* Sexy::IMAGE_RAIN;
Image* Sexy::IMAGE_REANIM_CABBAGEPULT_CABBAGE;
Image* Sexy::IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE;
...
Image* Sexy::IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1;
Image* Sexy::IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2;
Image* Sexy::IMAGE_REANIM_PUFFSHROOM_DECAY1;
Image* Sexy::IMAGE_REANIM_PUFFSHROOM_DECAY2;
Image* Sexy::IMAGE_REANIM_FIRESHROOM_BODY;
Image* Sexy::IMAGE_REANIM_FIRESHROOM_BODY2;
Image* Sexy::IMAGE_REANIM_FIRESHROOM_CAP1;
Image* Sexy::IMAGE_REANIM_FIRESHROOM_CAP2;
Image* Sexy::IMAGE_REANIM_FIRESHROOM_CAP3;
Image* Sexy::IMAGE_REANIM_DUMMY_BODY;
Image* Sexy::IMAGE_REANIM_DUMMY_CRACKED1;
Image* Sexy::IMAGE_REANIM_DUMMY_CRACKED2;
Image* Sexy::IMAGE_REANIM_ICENUT_BODY2;
Image* Sexy::IMAGE_REANIM_ICENUT_BODY3;
...
Image* Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET;
Image* Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET3;
Image* Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_HAND;
Image* Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_UPPER2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_DIVER1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_DIVER2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_DIVER3;
...
Image* Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR3;
...
Image* Sexy::IMAGE_SEEDSUNBANK;
Image* Sexy::IMAGE_SEEDBANKEND;
...
Image* Sexy::IMAGE_ZOMBIEDISCOHEAD;
...
Image* Sexy::IMAGE_ZOMBIEGARGANTUARHEAD;
Image* Sexy::IMAGE_ZOMBIEREDEYEGARGANTUARHEAD;
...
Image* Sexy::IMAGE_BOARD_SELECTOR_BLUE;
Image* Sexy::IMAGE_P2_ARROW;
Image* Sexy::IMAGE_SEED_SELECTOR_GREEN;
Image* Sexy::IMAGE_BOARD_SELECTOR_GREEN;
Image* Sexy::IMAGE_P3_ARROW;
Image* Sexy::IMAGE_SEED_SELECTOR_RED;
Image* Sexy::IMAGE_BOARD_SELECTOR_RED;
Image* Sexy::IMAGE_P4_ARROW;
Image* Sexy::IMAGE_SPEEDBUTTON;
Image* Sexy::IMAGE_SPEEDBUTTON_ACTIVATED;
Image* Sexy::IMAGE_P1_TEXT;
Image* Sexy::IMAGE_P2_TEXT;
Image* Sexy::IMAGE_P3_TEXT;
Image* Sexy::IMAGE_P4_TEXT;
Image* Sexy::IMAGE_BUSH3;
Image* Sexy::IMAGE_BUSH4;
Image* Sexy::IMAGE_BUSH5;
Image* Sexy::IMAGE_NIGHTBUSH3;
Image* Sexy::IMAGE_NIGHTBUSH4;
Image* Sexy::IMAGE_NIGHTBUSH5;
Image* Sexy::IMAGE_FLASHLIGHT_LIGHT;
/*Image* Sexy::IMAGE_P1_LABEL;
Image* Sexy::IMAGE_P2_LABEL;*/
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		IMAGE_BOARD_SELECTOR_BLUE = aMgr.GetImageThrow("IMAGE_BOARD_SELECTOR_BLUE");
		IMAGE_P2_ARROW = aMgr.GetImageThrow("IMAGE_P2_ARROW");
		IMAGE_SEED_SELECTOR_BLUE = aMgr.GetImageThrow("IMAGE_SEED_SELECTOR_BLUE");
		IMAGE_BOARD_SELECTOR_GREEN = aMgr.GetImageThrow("IMAGE_BOARD_SELECTOR_GREEN");
		IMAGE_P3_ARROW = aMgr.GetImageThrow("IMAGE_P3_ARROW");
		IMAGE_SEED_SELECTOR_GREEN = aMgr.GetImageThrow("IMAGE_SEED_SELECTOR_GREEN");
		IMAGE_BOARD_SELECTOR_RED = aMgr.GetImageThrow("IMAGE_BOARD_SELECTOR_RED");
		IMAGE_P4_ARROW = aMgr.GetImageThrow("IMAGE_P4_ARROW");
		IMAGE_SEED_SELECTOR_RED = aMgr.GetImageThrow("IMAGE_SEED_SELECTOR_RED");
		IMAGE_SPEEDBUTTON = aMgr.GetImageThrow("IMAGE_SPEEDBUTTON");
		IMAGE_SPEEDBUTTON_ACTIVATED = aMgr.GetImageThrow("IMAGE_SPEEDBUTTON_ACTIVATED");
		IMAGE_P1_TEXT = aMgr.GetImageThrow("IMAGE_P1_TEXT");
		IMAGE_P2_TEXT = aMgr.GetImageThrow("IMAGE_P2_TEXT");
		IMAGE_P3_TEXT = aMgr.GetImageThrow("IMAGE_P3_TEXT");
		IMAGE_P4_TEXT = aMgr.GetImageThrow("IMAGE_P4_TEXT");
		...
		IMAGE_NIGHTBUSH3 = aMgr.GetImageThrow("IMAGE_NIGHTBUSH3");
		IMAGE_NIGHTBUSH4 = aMgr.GetImageThrow("IMAGE_NIGHTBUSH4");
		IMAGE_NIGHTBUSH5 = aMgr.GetImageThrow("IMAGE_NIGHTBUSH5");
		...
		IMAGE_DUMMYMETER = aMgr.GetImageThrow("IMAGE_DUMMYMETER");
		IMAGE_TARGETMETER = aMgr.GetImageThrow("IMAGE_TARGETMETER");
		IMAGE_TARGET_X = aMgr.GetImageThrow("IMAGE_TARGET_X");
		...
		IMAGE_WIDE_POOL = aMgr.GetImageThrow("IMAGE_WIDE_POOL");
		IMAGE_POOLSPARKLY = aMgr.GetImageThrow("IMAGE_POOLSPARKLY");
		IMAGE_POOL_BASE = aMgr.GetImageThrow("IMAGE_POOL_BASE");
		IMAGE_WIDE_POOL_BASE = aMgr.GetImageThrow("IMAGE_WIDE_POOL_BASE");
		IMAGE_WIDE_POOL_SHADING = aMgr.GetImageThrow("IMAGE_WIDE_POOL_SHADING");
		...
		IMAGE_SEASHROOM_PUFF1 = aMgr.GetImageThrow("IMAGE_SEASHROOM_PUFF1");
		IMAGE_SPORESHROOM_SPORE = aMgr.GetImageThrow("IMAGE_SPORESHROOM_SPORE");
		IMAGE_ICY_FUMESHROOM_CLOUD = aMgr.GetImageThrow("IMAGE_ICY_FUMESHROOM_CLOUD");
		...
		IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE = aMgr.GetImageThrow("IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE");
		...
		IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1");
		IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2 = aMgr.GetImageThrow("IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2");
		IMAGE_REANIM_PUFFSHROOM_DECAY1 = aMgr.GetImageThrow("IMAGE_REANIM_PUFFSHROOM_DECAY1");
		IMAGE_REANIM_PUFFSHROOM_DECAY2 = aMgr.GetImageThrow("IMAGE_REANIM_PUFFSHROOM_DECAY2");
		IMAGE_REANIM_FIRESHROOM_BODY = aMgr.GetImageThrow("IMAGE_REANIM_FIRESHROOM_BODY");
		IMAGE_REANIM_FIRESHROOM_BODY2 = aMgr.GetImageThrow("IMAGE_REANIM_FIRESHROOM_BODY2");
		IMAGE_REANIM_FIRESHROOM_CAP1 = aMgr.GetImageThrow("IMAGE_REANIM_FIRESHROOM_CAP1");
		IMAGE_REANIM_FIRESHROOM_CAP2 = aMgr.GetImageThrow("IMAGE_REANIM_FIRESHROOM_CAP2");
		IMAGE_REANIM_FIRESHROOM_CAP3 = aMgr.GetImageThrow("IMAGE_REANIM_FIRESHROOM_CAP3");
		IMAGE_REANIM_DUMMY_BODY = aMgr.GetImageThrow("IMAGE_REANIM_DUMMY_BODY");
		...
		IMAGE_REANIM_ICENUT_BODY2 = aMgr.GetImageThrow("IMAGE_REANIM_ICENUT_BODY2");
		IMAGE_REANIM_ICENUT_BODY3 = aMgr.GetImageThrow("IMAGE_REANIM_ICENUT_BODY3");
		...
		IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BLACK_FOOTBALL_HELMET");
		IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BLACK_FOOTBALL_HELMET2");
		IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BLACK_FOOTBALL_HELMET3");
		IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_HAND = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_BLACK_FOOTBALL_LEFTARM_HAND");
		IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_UPPER2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_FOOTBALL_LEFTARM_UPPER2");
		IMAGE_REANIM_ZOMBIE_DIVER1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_DIVER1");
		IMAGE_REANIM_ZOMBIE_DIVER2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_DIVER2");
		IMAGE_REANIM_ZOMBIE_DIVER3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_DIVER3");
		...
		IMAGE_REANIM_ZOMBIE_GLASSDOOR1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GLASSDOOR1");
		IMAGE_REANIM_ZOMBIE_GLASSDOOR2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GLASSDOOR2");
		IMAGE_REANIM_ZOMBIE_GLASSDOOR3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GLASSDOOR3");
		...
		IMAGE_SEEDSUNBANK = aMgr.GetImageThrow("IMAGE_SEEDSUNBANK");
		IMAGE_SEEDBANKEND = aMgr.GetImageThrow("IMAGE_SEEDBANKEND");
		...
		IMAGE_ZOMBIEDISCOHEAD = aMgr.GetImageThrow("IMAGE_ZOMBIEDISCOHEAD");
		...
		IMAGE_ZOMBIEGARGANTUARHEAD = aMgr.GetImageThrow("IMAGE_ZOMBIEGARGANTUARHEAD");
		IMAGE_ZOMBIEREDEYEGARGANTUARHEAD = aMgr.GetImageThrow("IMAGE_ZOMBIEREDEYEGARGANTUARHEAD");
...
int	Sexy::SOUND_SLINGPEALOB1;
int	Sexy::SOUND_SLINGPEALOB2;
int	Sexy::SOUND_SLINGPEALOB3;
int	Sexy::SOUND_PUNCHED;
int	Sexy::SOUND_UPPERCUTED;
int	Sexy::SOUND_SPORESHROOM_SHOOT;
int	Sexy::SOUND_ASRIEL_SHOOTINGSTAR;
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		SOUND_SLINGPEALOB1 = aMgr.GetSoundThrow("SOUND_SLINGPEALOB1");
		SOUND_SLINGPEALOB2 = aMgr.GetSoundThrow("SOUND_SLINGPEALOB2");
		SOUND_SLINGPEALOB3 = aMgr.GetSoundThrow("SOUND_SLINGPEALOB3");
		SOUND_PUNCHED = aMgr.GetSoundThrow("SOUND_PUNCHED");
		SOUND_UPPERCUTED = aMgr.GetSoundThrow("SOUND_UPPERCUTED");
		SOUND_SPORESHROOM_SHOOT = aMgr.GetSoundThrow("SOUND_SPORESHROOM_SHOOT");
		SOUND_ASRIEL_SHOOTINGSTAR = aMgr.GetSoundThrow("SOUND_ASRIEL_SHOOTINGSTAR");
...
void* gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] =
{
	...
	&Sexy::IMAGE_SEEDCHOOSER_BACKGROUND2,
	...
	&Sexy::IMAGE_DUMMYMETER,
	&Sexy::IMAGE_TARGETMETER,
	&Sexy::IMAGE_TARGET_X,
	&Sexy::IMAGE_TROPHY,
	&Sexy::IMAGE_DIAMOND_TROPHY,
	&Sexy::IMAGE_TROPHY_HI_RES,
	&Sexy::IMAGE_DIAMOND_TROPHY_HI_RES,
	&Sexy::IMAGE_MINIGAME_TROPHY,
	&Sexy::IMAGE_MINIGAME_DIAMOND_TROPHY,
	...
	&Sexy::IMAGE_SHOVEL,
	&Sexy::IMAGE_BUTTER_ICON,
	&Sexy::IMAGE_HAMMER_ICON,
	...
	&Sexy::IMAGE_DIAMOND_SUNFLOWER_TROPHY,
	...
	&Sexy::IMAGE_BEJEWEL_SELECTORSHADOW,
	...
	&Sexy::IMAGE_SEASHROOM_PUFF1,
	&Sexy::IMAGE_SPORESHROOM_SPORE,
	&Sexy::IMAGE_ICY_FUMESHROOM_CLOUD,
	&Sexy::IMAGE_ZAMBONISMOKE,
	&Sexy::IMAGE_ZOMBIEDANCERHEAD,
	&Sexy::IMAGE_ZOMBIEDISCOHEAD,
	...
	&Sexy::IMAGE_ZOMBIEGARGANTUARHEAD,
	&Sexy::IMAGE_ZOMBIEREDEYEGARGANTUARHEAD,
	...
	&Sexy::IMAGE_SQUIRREL,
	&Sexy::IMAGE_BOARD_SELECTOR, //funcust
	&Sexy::IMAGE_P1_ARROW,
	&Sexy::IMAGE_SEED_SELECTOR,
	&Sexy::IMAGE_BOARD_SELECTOR_BLUE,
	&Sexy::IMAGE_P2_ARROW,
	&Sexy::IMAGE_SEED_SELECTOR_BLUE,
	&Sexy::IMAGE_BOARD_SELECTOR_GREEN,
	&Sexy::IMAGE_P3_ARROW,
	&Sexy::IMAGE_SEED_SELECTOR_GREEN,
	&Sexy::IMAGE_BOARD_SELECTOR_RED,
	&Sexy::IMAGE_P4_ARROW,
	&Sexy::IMAGE_SEED_SELECTOR_RED,
	&Sexy::IMAGE_SPEEDBUTTON,
	&Sexy::IMAGE_SPEEDBUTTON_ACTIVATED,
	&Sexy::IMAGE_P1_TEXT,
	&Sexy::IMAGE_P2_TEXT,
	&Sexy::IMAGE_P3_TEXT,
	&Sexy::IMAGE_P4_TEXT,
	...
	&Sexy::IMAGE_BUSH4,
	&Sexy::IMAGE_BUSH5,
	&Sexy::IMAGE_NIGHTBUSH3,
	&Sexy::IMAGE_NIGHTBUSH4,
	&Sexy::IMAGE_NIGHTBUSH5,
	&Sexy::IMAGE_FLASHLIGHT_LIGHT,
	...
	&Sexy::IMAGE_REANIM_EXPLODE_O_NUT_CRACKED1,
	&Sexy::IMAGE_REANIM_EXPLODE_O_NUT_CRACKED2,
	&Sexy::IMAGE_REANIM_PUFFSHROOM_DECAY1,
	&Sexy::IMAGE_REANIM_PUFFSHROOM_DECAY2,
	&Sexy::IMAGE_REANIM_FIRESHROOM_BODY,
	&Sexy::IMAGE_REANIM_FIRESHROOM_BODY2,
	&Sexy::IMAGE_REANIM_FIRESHROOM_CAP1,
	&Sexy::IMAGE_REANIM_FIRESHROOM_CAP2,
	&Sexy::IMAGE_REANIM_FIRESHROOM_CAP3,
	&Sexy::IMAGE_REANIM_DUMMY_BODY,
	&Sexy::IMAGE_REANIM_DUMMY_CRACKED1,
	&Sexy::IMAGE_REANIM_DUMMY_CRACKED2,
	&Sexy::IMAGE_REANIM_ICENUT_BODY2,
	&Sexy::IMAGE_REANIM_ICENUT_BODY3,
	...
	&Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR1,
	&Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GLASSDOOR3,
	&Sexy::IMAGE_REANIM_ZOMBIE_FLAG1,
	&Sexy::IMAGE_REANIM_ZOMBIE_FLAG2,
	...
	&Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET,
	&Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET2,
	&Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_HELMET3,
	&Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_HAND,
	&Sexy::IMAGE_REANIM_ZOMBIE_BLACKFOOTBALL_LEFTARM_UPPER2,
	&Sexy::IMAGE_REANIM_ZOMBIE_DIVER1,
	&Sexy::IMAGE_REANIM_ZOMBIE_DIVER2,
	&Sexy::IMAGE_REANIM_ZOMBIE_DIVER3,
	...
	&Sexy::IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE,
	...
	&Sexy::SOUND_SLINGPEALOB1,
	&Sexy::SOUND_SLINGPEALOB2,
	&Sexy::SOUND_SLINGPEALOB3,
	&Sexy::SOUND_PUNCHED,
	&Sexy::SOUND_UPPERCUTED,
	&Sexy::SOUND_SPORESHROOM_SHOOT,
	&Sexy::SOUND_ASRIEL_SHOOTINGSTAR,
	...
	//
	&Sexy::IMAGE_BACKGROUND3WIDE,
	&Sexy::IMAGE_BACKGROUND3UNSODDED,
	//
	&Sexy::IMAGE_BACKGROUND3GRASS,
	//
	&Sexy::IMAGE_BACKGROUNDHIGHGROUND,
	...
	&Sexy::IMAGE_BACKGROUND5_POLE,
	&Sexy::IMAGE_BACKGROUND5_TREES,
	&Sexy::IMAGE_BACKGROUND5_GAMEOVER_MASK,
	/* DelayLoad_Background6 */
	&Sexy::IMAGE_BACKGROUND6BOSS,
	& Sexy::IMAGE_BACKGROUND6_POLE,
	& Sexy::IMAGE_BACKGROUND6_TREES,
	...
	&Sexy::IMAGE_CHALLENGE_THUMBNAILS2,
