...
enum BackgroundType
{
    ...
    BACKGROUND_2_NIGHT,
    BACKGROUND_3_POOL,
    BACKGROUND_3_POOLWIDE,
    BACKGROUND_3_UNSODDED,
    BACKGROUND_3_GRASS,
    BACKGROUND_4_FOG,
    BACKGROUND_5_ROOF,
    BACKGROUND_6_BOSS,
    BACKGROUND_6_AIRRAID,
    BACKGROUND_GRAVEYARD,
    BACKGROUND_HIGHGROUND,
...
enum GameMode
{
    ...
    GAMEMODE_COOP_SURVIVAL_NORMAL_STAGE_6,
    ...
    GAMEMODE_COOP_SURVIVAL_HARD_STAGE_6,
    ...
    GAMEMODE_COOP_SURVIVAL_ENDLESS_STAGE_6,
    GAMEMODE_CHALLENGE_ZOMBOTANY,
    ...
    GAMEMODE_CHALLENGE_SURPRISE_ATTACK,
    GAMEMODE_CHALLENGE_ZOMBOTANY_2,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_2,
    GAMEMODE_CHALLENGE_POGO_PARTY,
    GAMEMODE_CHALLENGE_DR_ZOMBOSS_REVENGE,
    GAMEMODE_CHALLENGE_SQUIRREL,
    GAMEMODE_CHALLENGE_RAINING_SEEDS_2,
    GAMEMODE_CHALLENGE_BIG_TROUBLE,
    GAMEMODE_CHALLENGE_HIGH_GRAVITY,
    GAMEMODE_CHALLENGE_BIG_TIME,
    GAMEMODE_CHALLENGE_BUNGEE_BLITZ,
    GAMEMODE_CHALLENGE_SEEING_FLOWERS,
    GAMEMODE_CHALLENGE_UNSODDED,
    GAMEMODE_CHALLENGE_DARK_STORMY_NIGHT,
    GAMEMODE_CHALLENGE_PORTAL_COMBAT_2,
    GAMEMODE_CHALLENGE_HEAT_WAVE,
    GAMEMODE_CHALLENGE_SUNNY_DAY,
    GAMEMODE_CHALLENGE_CAN_YOU_DIG_IT,
    GAMEMODE_CHALLENGE_DANCE_PARTY,
    GAMEMODE_CHALLENGE_AIR_RAID,
    GAMEMODE_CHALLENGE_BLIND_FAITH,
    GAMEMODE_CHALLENGE_GRAVE_DANGER,
    GAMEMODE_CHALLENGE_ICE_LEVEL,
    GAMEMODE_CHALLENGE_ART_SEEING_NUTS,
    GAMEMODE_CHALLENGE_METAL_FESTIVAL,
    ...
    GAMEMODE_CHALLENGE_LAST_STAND_DAY,
    GAMEMODE_CHALLENGE_LAST_STAND_NIGHT,
    GAMEMODE_CHALLENGE_LAST_STAND_POOL,
    GAMEMODE_CHALLENGE_LAST_STAND_FOG,
    GAMEMODE_CHALLENGE_LAST_STAND_ROOF,
    GAMEMODE_CHALLENGE_LAST_STAND_GLOOM,
    GAMEMODE_CHALLENGE_TOO_MANY_ECLIPSES,
    GAMEMODE_CHALLENGE_HARD_HEADED,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_3,
    GAMEMODE_CHALLENGE_BLOOD_MOON,
    GAMEMODE_CHALLENGE_WE_SMASH,
    GAMEMODE_CHALLENGE_POOL_PARTY,
    GAMEMODE_CHALLENGE_SLOT_MACHINE_2,
    GAMEMODE_CHALLENGE_BUTTERED_POPCORN,
    GAMEMODE_CHALLENGE_OPEN_FIRE,
    GAMEMODE_CHALLENGE_UNSODDED_2,
    GAMEMODE_CHALLENGE_BORDER_TREATY,
    GAMEMODE_CHALLENGE_FLOOR_IS_LAVA,
    GAMEMODE_CHALLENGE_WEIRDMAGEDDON,
    GAMEMODE_CHALLENGE_STORMY_NIGHT_2,
    GAMEMODE_CHALLENGE_RENEWABLE_ENERGY,
    GAMEMODE_CHALLENGE_NONE_SHALL_PASS,
    GAMEMODE_CHALLENGE_WHACK_A_ZOMBIE_2,
    GAMEMODE_CHALLENGE_LIGHTS_OUT,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,
    GAMEMODE_CHALLENGE_GRAVEYARD_ENCOUNTER,
    GAMEMODE_CHALLENGE_SPEEDY_LANES,
    GAMEMODE_CHALLENGE_BEJEWELED_2,
    GAMEMODE_CHALLENGE_PLANT_MINIMALIST,
    GAMEMODE_CHALLENGE_EVERYONE_IS_DEAD,
    GAMEMODE_CHALLENGE_BRUTAL_EVENING,
    GAMEMODE_CHALLENGE_ZOMBIE_TRAP,
    GAMEMODE_CHALLENGE_HAIL,
    GAMEMODE_CHALLENGE_WINDNESDAY,
    GAMEMODE_CHALLENGE_HIGHGROUND,
    GAMEMODE_CHALLENGE_HEAVY_WEAPON,
    GAMEMODE_CHALLENGE_HOMERUN_DERBY,
    GAMEMODE_CHALLENGE_HEAVY_RAIN,
    GAMEMODE_CHALLENGE_BUNGEE_BLITZ_2,
    GAMEMODE_CHALLENGE_BOMB_ALL,
    GAMEMODE_CHALLENGE_INVISIGHOUL_REVERSE,
    GAMEMODE_CHALLENGE_ZOMBIEZOMBIE,
    GAMEMODE_CHALLENGE_INFLATION,
    GAMEMODE_CHALLENGE_WORLDS_COLLIDING,
    GAMEMODE_CHALLENGE_PLANT_FUSION,
    GAMEMODE_CHALLENGE_DARK_FOGGY_NIGHT,
    GAMEMODE_CHALLENGE_SLOWMO,
    GAMEMODE_CHALLENGE_FOREST,
    GAMEMODE_VERSUS_PLANTS_VS_PLANTS,
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    NUM_GAME_MODES
};
...
enum ProjectileMotion
{
    ...
    MOTION_STAR = 6,  // 斜向运动
    MOTION_FLOAT_OVER = 7,  // 缓慢漂浮向右（无碰撞）
    MOTION_HOMING = 8   // 追踪
};
enum ProjectileType
{
    ...
    PROJECTILE_FROSTCABBAGE = 13,
    PROJECTILE_SLINGPEA = 14,
    PROJECTILE_SPORE = 15,
    PROJECTILE_PLASMABALL = 16,
    PROJECTILE_BOMBBERRY = 17,
    PROJECTILE_STARCICLE = 18,
    PROJECTILE_MAGNIFYING_GRASS = 19,
    PROJECTILE_SHOOTING_STAR = 20,
    PROJECTILE_CACTUS_SPIKE = 21,
    PROJECTILE_SEAPUFF = 22, 
    NUM_PROJECTILES
};
enum ReanimationType
{
    ...
    REANIM_PLASMA_FIRE,
    REANIM_SLINGPEA,
    REANIM_ICY_FUMESHROOM,
    REANIM_ZOMBIE_DISCO,
    REANIM_ZOMBIE_DISCO_BACKUP,
    REANIM_BONKCHOY,
    REANIM_SPORESHROOM,
    REANIM_ARTICNUT,
    REANIM_DUMMY,
    ...
    REANIM_AMPLIFLOWER,
    REANIM_SHOOTINGSTAR,
    REANIM_PROJECTILE_SHOOTINGSTAR,
    REANIM_SEEDROOT,
    REANIM_MAGNIFYINGGRASS,
    REANIM_STINGER,
    REANIM_BRAVEYSHROOM,
    REANIM_PORTAL_DIAMOND,
...
enum RenderObjectType
{
    ...
    RENDER_ITEM_TOP_UI,
    RENDER_ITEM_FOG,
    RENDER_ITEM_DARKNESS,
    RENDER_ITEM_OVERLAY,
    RENDER_ITEM_OVERLAYCHEAP,
    RENDER_ITEM_BUSH_OVERLAY,
    RENDER_ITEM_TOP_OVERLAY,
    RENDER_ITEM_STORM,
...
enum SeedType
{
    ...
    SEED_FLOWERPOT = 33,
    SEED_KERNELPULT = 34,
    SEED_INSTANTCOFFEE = 35,
    SEED_GARLIC = 36,
    SEED_UMBRELLA = 37,
    SEED_MARIGOLD = 38,
    SEED_MELONPULT = 39,
    SEED_SPORE_SHROOM = 40,
    SEED_AMPLIFLOWER = 41,
    SEED_GATLINGPEA = 42,
    SEED_TWINSUNFLOWER = 43,
    SEED_GLOOMSHROOM = 44,
    SEED_CATTAIL = 45,
    SEED_WINTERMELON = 46,
    SEED_GOLD_MAGNET = 47,
    ...
    SEED_COBCANNON = 49,
    SEED_IMITATER = 50,
    SEED_FROST_CABBAGE = 51,
    SEED_SLINGPEA = 52,
    SEED_WATERPOT = 53,
    SEED_CHILIBEAN = 54,
    SEED_MOONFLOWER = 55,
    SEED_SUNBLOOM = 56,
    SEED_EINSTEINAPPLE = 57,
    SEED_PLASMAWOOD = 58,
    SEED_ICYFUMESHROOM = 59,
    SEED_BONKCHOY = 60,
    SEED_BOMBBERRY = 61,
    SEED_CHERRYHOVERBOMB = 62,
    SEED_SEEDROOT = 63,
    SEED_HURRIKALE = 64,
    SEED_PRIMAL_SUNFLOWER = 65,
    SEED_ARTIC_NUT = 66,
    SEED_STARCICLE = 67,
    SEED_MAGNIFYINGGRASS = 68,
    SEED_DUMMY = 69,
    SEED_SUNBEAN = 70,
    SEED_FIRESHROOM = 71,
    SEED_SUPERCHOMPER = 72,
    SEED_SHOOTINGSTAR = 73,
    SEED_STINGER = 74,
    SEED_BRAVEYSHROOM = 75,
    SEED_ICEBERG_LETTUCE = 76,
    SEED_FLYINGPOT = 77,
    SEED_EXPLODE_O_NUT,
    SEED_GIANT_WALLNUT,
    SEED_SPROUT,
...
enum StoreItem
{
    ...
    STORE_ITEM_PLANT_EXPENSIVE_NUT,
    ...
    STORE_ITEM_FIRSTAID,
    STORE_ITEM_PVZ,
    STORE_ITEM_THREE_MALLETS,
    STORE_ITEM_SIX_MALLETS,
    STORE_ITEM_NINE_MALLETS,
    NUM_STORE_ITEMS,
...
enum ZombiePhase
{
    ...
    PHASE_ZOMBIE_INTANGIBLE,
    PHASE_ZOMBIE_WRAITH_GASP,
};
enum ZombieType
{
    ZOMBIE_INVALID = -1,
    ...
    ZOMBIE_SQUASH_HEAD,
    ZOMBIE_TALLNUT_HEAD,
    ZOMBIE_HYPNOSHROOM_HEAD,
    ZOMBIE_EXPLODE_O_NUT_HEAD,
