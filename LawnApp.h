...
public:
	...
	void							StartDiscord();
	void							UpdateDiscordRPC(const std::string Details = "", const std::string State = "", const std::string ImageLarge = "logo", const std::string ImageSmall = "logo");
	...
	bool							IsBigTroubleLevel();
	static bool							IsLastStandLevel(GameMode theGameMode);
	...
	bool							HasBeatenChallengeVeteran(GameMode theGameMode);
	...
	int								GetNumTrophiesVeteran(ChallengePage thePage);
	/*inline*/ bool					EarnedGoldTrophy();
	bool							EarnedDiamondTrophy();
	...
	int								TrophiesNeedForDiamondSunflower();
