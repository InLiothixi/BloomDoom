...
enum MusicTune
{
	...
	MUSIC_TUNE_GRAVEYARD_BOSS,
	MUSIC_TUNE_FLORAL_HEAVEN,
	MUSIC_TUNE_POOL_WATERYGRAVES_FAST,
	MUSIC_TUNE_POOL_WATERYGRAVES_SLOW,
	MUSIC_TUNE_GLOOMBLOOM,
	MUSIC_TUNE_HELP,
	MUSIC_TUNE_WOODY_TOMBSTONE,
	MUSIC_TUNE_LUNACY_CADABREATH,
	NUM_MUSIC_TUNES
};
...
enum MusicFile
{
	...
	MUSIC_FILE_GRASS_THE_MOON_HIHATS,
	MUSIC_FILE_GRASS_THE_MOON_DRUMS,
	MUSIC_FILE_BRAIN_STORM,
	MUSIC_FILE_FALLING_CRYSTALS,
	MUSIC_FILE_RAINY_RIGOR_MORMIST,
	MUSIC_FILE_GRAVEYARD_BOSS,
	MUSIC_FILE_FINAL_BOSS_BRAINIAC_MANIAC_HQ,
	MUSIC_FILE_CEREBRAWL_HQ,
	MUSIC_FILE_LOONBOON_HQ,
	MUSIC_FILE_ULTIMATEBATTLE_HQ,
	MUSIC_FILE_FLORAL_HEAVEN,
	MUSIC_FILE_POOL_WATERYGRAVES_FAST,
	MUSIC_FILE_POOL_WATERYGRAVES_SLOW,
	MUSIC_FILE_GLOOMBLOOM,
	MUSIC_FILE_HELP,
	MUSIC_FILE_WOODY_TOMBSTONE,
	MUSIC_FILE_WOODY_TOMBSTONE_HIHATS,
	MUSIC_FILE_WOODY_TOMBSTONE_DRUMS,
	MUSIC_FILE_LUNACY_CADABREATH,
	NUM_MUSIC_FILES
};
...
public:
	...
	HMUSIC						GetBassStreamHandle(MusicFile theMusicFile);
	void						StartGameMusic();
