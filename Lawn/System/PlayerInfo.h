...
public:
    ...
    int                 mPurchases[NUM_STORE_ITEMS];                     //+0x1C0
    ...
    int                 mLastSeedsInBank[SEEDBANK_MAX];
    __time32_t          mLastTimeVisitedZen;
    __time32_t          mLastTimeStinkyAwake;
    PottedPlant         mPottedPlant[MAX_POTTED_PLANTS];    //+0x358
    int                 mChallengeVeteranRecords[NUM_GAME_MODES];
