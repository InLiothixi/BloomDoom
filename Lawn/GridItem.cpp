...
void GridItem::DrawGridItem(Graphics* g)
{
    ...
    case GridItemType::GRIDITEM_PORTAL_DIAMOND:
...
void GridItem::OpenPortal()
{
    ...
    float aYPos = mBoard->GridToPixelY(mGridX, mGridY) - 65.0f;
    ...
    if (aPortalReanim == nullptr)
    {
        ...
        if (mGridItemType == GridItemType::GRIDITEM_PORTAL_SQUARE || mGridItemType == GridItemType::GRIDITEM_PORTAL_DIAMOND)
        {
            aYPos += 25.0f;
            aXPos -= 4.0f;

            if (mGridItemType == GridItemType::GRIDITEM_PORTAL_DIAMOND)
                aReanimType = ReanimationType::REANIM_PORTAL_DIAMOND;
            else
...
bool GridItem::IsOpenPortal()
{
	return mGridItemState != GridItemState::GRIDITEM_STATE_PORTAL_CLOSED && 
		(mGridItemType == GridItemType::GRIDITEM_PORTAL_CIRCLE || mGridItemType == GridItemType::GRIDITEM_PORTAL_SQUARE || mGridItemType == GridItemType::GRIDITEM_PORTAL_DIAMOND);
}
...
void GridItem::UpdatePortal()
{
    ...
    else if (aPortalReanim->mLoopType == ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD && aPortalReanim->mLoopCount > 0)
    {
        ...
        float aYPos = mBoard->GridToPixelY(mGridX, mGridY) - 39.0f;
        if (mGridItemType == GridItemType::GRIDITEM_PORTAL_SQUARE || mGridItemType == GridItemType::GRIDITEM_PORTAL_DIAMOND)
        {
...
void GridItem::Update()
{
    ...
    if (mGridItemType == GridItemType::GRIDITEM_PORTAL_CIRCLE || mGridItemType == GridItemType::GRIDITEM_PORTAL_SQUARE || mGridItemType == GridItemType::GRIDITEM_PORTAL_DIAMOND)
    {
        UpdatePortal();
    }
