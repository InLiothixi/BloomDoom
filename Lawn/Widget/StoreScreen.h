...
public:
    ...
    void                        DrawItemIcon(Graphics* g, int theItemPosition, StoreItem theItemType, bool theIsForHighlight, float offsetX = 0, float offsetY = 0);
    void                        DrawItem(Graphics* g, int theItemPosition, StoreItem theItemType, float offsetX = 0, float offsetY = 0);
