...
protected:
	enum
	{
		...
		NewOptionsDialog_HQMusic,
		NewOptionsDialog_VeteranMode,
		NewOptionsDialog_AutoPause,
		NewOptionsDialog_NextPage,
		NewOptionsDialog_PreviousPage,
	};
...
public:
	...
	Sexy::Checkbox*			mHQMusicCheckbox;				
	Sexy::Checkbox*			mVeteranModeCheckbox;
	Sexy::Checkbox*			mAutoPauseCheckbox;
	LawnStoneButton*		mAlmanacButton;						//+0x16C
	LawnStoneButton*		mBackToMainButton;					//+0x170
	LawnStoneButton*		mOtherButtons;
	LawnStoneButton*		mRestartButton;						//+0x174
	LawnStoneButton*		mLanguageButton;
	LawnStoneButton*		mHotkeysButton;
