...
{
    if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_RAINING_SEEDS || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_RAINING_SEEDS_2 || mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_WEIRDMAGEDDON || mApp->IsStormyNightLevel())
    {
