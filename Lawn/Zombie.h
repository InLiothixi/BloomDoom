...
constexpr const int RENDER_GROUP_ARMS = 0;
...
constexpr const int RENDER_GROUP_OVER_SHIELD = 4;
constexpr const int RENDER_GROUP_SHIELD_ARM = 5;
...
public:
    ...
    ReanimationID                   mPlantHeadID;
    ReanimationID                   mSpecialHeadReanimID;                       //+0x144
    ReanimationID                   mFlagReanimID;                       //+0x144
    int                             mFireballRow;                               //+0x148
    bool                            mIsFireBall;                                //+0x14C
    ReanimationID                   mMoweredReanimID;                           //+0x150
    int                             mLastPortalX;                               //+0x154
    bool                            isImmuneToGarlic;
    bool                            hasDiarrhea;
    int                             diarrheaCount;
    int                             avoidRow;
    bool                            mHasDucky;
    int                             mReverseCounter;
    float                           mPlantHeadOriginalAnimRate;
    int                             mDanceSwitchRows;
    bool                            mCannotBeHammered;
    bool                            mUpdateTwice;
    bool                            mGiant;
    bool                            mTiny;
    bool                            mWalkBack;
    float                           mGameOverStartX;
    float                           mGameOverStartY;
    bool                            mDropVelocityChange;
    float                           mPostDropVelocityX;
    int                             mHurrikaleTime;
    int                             mPrevHealth;
    bool                            mIsSunbeaned;
    int                             mSunProduced;
    ReanimationID                   mHelmetReanimID;
    ReanimationID                   mExtraReanimID;

    SeedType                        mPlantHeadType;
...
public:
    ...
    void                            TakeDamageForced(int theDamage, unsigned int theDamageFlags);
    void                            TakeBurnDamage(int theDamage, unsigned int theDamageFlags);
    ...
    int                             CountBungeesTargetingPlanterns();
    int                             CountNinjaImpsTargetingPlanterns();
    ...
    void                            DoBlink();
    void                            EndBlink();
    Reanimation*                    AttachBlinkAnim(Reanimation* theReanimation);
    void                            UpdateBlink();
};
