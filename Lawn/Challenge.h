...
constexpr const int MAX_PORTALS = 6;
...
public:
    ...
    // Opea Fire & Air Raid
    int						mSpecialLoseTimer;
    int						mAirRaidCLOUDTime = 0;
    int					    mAirRaidSTARTime = 0;
...
public:
    ...
    bool                    CanTargetZombieWithPortals(int mColumn, int mRow, Zombie* theZombie);
    bool                    CanTargetPlantWithPortals(Plant* thePlant, Plant* targetPlant);
