...
public:
    ...
    int     		    mSeedPacketsTime[SEEDBANK_MAX];
...
public:
    ...
    void			    UpdateWidth(bool fromBank = true);
...
void				    DrawSeedPacket(Graphics* g, float x, float y, SeedType theSeedType, SeedType theImitaterType, float thePercentDark, int theGrayness, bool theDrawCost, bool theUseCurrentCost, bool fromAward = false, float offX = 0);
