...
public:
    ...
    PlantID                 mPlantParentID;
    ZombieID                mZombieParentID;
...
public:
    ...
    void                    DoSplashDamage(void* theTarget);
