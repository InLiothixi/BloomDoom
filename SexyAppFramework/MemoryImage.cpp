...
void MemoryImage::EraseBlt(Image* theImage, int theX, int theY, const Rect& theSrcRect, const Color& theColor)
{
	theImage->mDrawn = true;
...
void MemoryImage::SlowStretchEraseBlt(Image* theImage, const Rect& theDestRect, const FRect& theSrcRect, const Color& theColor, int theDrawMode)
{
	theImage->mDrawn = true;
...
#include "MI_SlowStretchEraseBlt.inc"
...
void MemoryImage::StretchBlt(Image* theImage, const Rect& theDestRect, const Rect& theSrcRect, const Rect& theClipRect, const Color& theColor, int theDrawMode, bool fastStretch)
{
	...
	{
		if (theDrawMode == 2)
			SlowStretchEraseBlt(theImage, aDestRect, aSrcRect, theColor, theDrawMode);
		else
