...
{
	return ((theX >= mX - mHitOffsetX) && (theX < mX + mWidth - mHitOffsetX) &&
			(theY >= mY - mHitOffsetY) && (theY < mY + mHeight - mHitOffsetY));
}

Rect Widget::GetInsetRect()
{
	return Rect(mX - mHitOffsetX + mMouseInsets.mLeft, mY - mHitOffsetY + mMouseInsets.mTop,
