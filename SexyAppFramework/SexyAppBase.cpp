...
{	
	...
	RegistryWriteInteger("Fake3D", mFake3DAcceleration ? 1 : 0);
	RegistryWriteInteger("HQMusic", mHQMusic ? 1 : 0);
	RegistryWriteInteger("VeteranMode", mVeteranMode ? 1 : 0);
	RegistryWriteInteger("AutoPause", mAutoPause ? 1 : 0);
}
...
void SexyAppBase::ReadFromRegistry()
{
	...
	if (RegistryReadInteger("Fake3D", &anInt))
		mFake3DAcceleration = anInt == 1;

	if (RegistryReadInteger("HQMusic", &anInt))
		mHQMusic = anInt == 1;

	if (RegistryReadInteger("VeteranMode", &anInt))
		mVeteranMode = anInt == 1;

	if (RegistryReadInteger("AutoPause", &anInt))
		mAutoPause = anInt == 1;
